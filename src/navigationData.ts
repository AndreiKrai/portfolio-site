...
const commercialsData: CardData[] = [
  ...
  },
  {
    ...
    projectReview:
      "A comprehensive application was successfully developed and delivered for a transport company, tailored specifically for their drivers. The app enables individual driver logins and provides a centralized platform for managing all transport service operations. Through the app, drivers can seamlessly check orders, search for clients, create packages, and handle various logistics tasks in one place. The application was completed and successfully launched on the App Store, aligning with the company's requirements and providing an efficient solution for their drivers.",
  },
  {
    id: 3,
    image: jobApply24,
...
const petData: CardData[] = [
  {
    ...
    alt: "Node",
    title: "Node.js",
    subtitle: "Backend drived by Node.js",
  ...
  },
  {
    ...
    subtitle: "Responsive site drived by Vanila JS",
    ...
    screenshorts: ["../assets/ice-web-2.png", "../assets/ice-web-3.png"],
    descriptionImage: "../assets/ice-h.png",
    projectReview:
      "A group project was undertaken to develop a dynamic website for an ice cream shop using vanilla JavaScript, HTML, and CSS. The project aimed to deliver a clean and visually appealing interface, featuring interactive elements like a dynamic menu, and engaging animations.",
  },
  {
    id: 12,
    image: run,
    ...
    gitLink: "https://github.com/AndreiKrai/run-server",
